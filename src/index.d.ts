...
export class ExpandableCalendar extends React.Component<CalendarMarkingProps & CalendarListBaseProps> {}
...
interface CalendarProviderProps {
    ...
    todayButtonStyle: object | number | Array<any>;
    /** The opacity for the disabled today button (0-1) */
    disabledOpacity: number;
}

export class CalendarProvider extends React.Component<T extends CalendarProviderProps> {}